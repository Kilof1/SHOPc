...
const SideBar: React.FC<SideBarProops> = (props: SideBarProops) => {
    ...
    <div className="sidebar-menu" ref={ref}>
      <ul className="sidebar-menu__categories">
        {navOptions.map((n, i) => (
          <div key={i}>
            <li
              className="sidebar-menu__categories__list"
              key={i}
              id={n.name}
            ...
            >
              <ul>
                <p className="sidebar-menu__dropdown-active__title">
                  {n.categories[0].title}
                </p>
                {n.categories[0].values.map((v, i) => (
                  <li
                    onClick={props.click}
                    className="sidebar-menu__dropdown-active__item"
                    key={i}
                  >
                    {v}
                  </li>
